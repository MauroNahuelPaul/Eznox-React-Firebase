...
export const Nosotros = () => {
    ...
    return (
        <div>
            ...
            <div className="irCuentaContainer">
                <p className='irCuentaContainer__texto'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sit amet facilisis magna etiam tempor.
                </p>
                <Link to="/login " className='irCuentaContainer__enlace'>
                    <div>
                        <p>
                            Comenzar
                        </p>
